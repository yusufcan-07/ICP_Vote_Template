...
thread_local! {
    ...
    static PROPOSAL_MAP: RefCell<StableBTreeMap<u64,Proposal,Memory>> = RefCell::new(StableBTreeMap::init(MemoryManager.with(|m| m.borrow().get(MemoryId::new(0)))));
